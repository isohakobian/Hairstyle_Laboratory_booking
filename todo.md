...
- [x] Include client Instagram handle and studio address in Google Calendar event URL generation
- [x] Show client Instagram directly in the admin booking card
- [x] Add regression test for Instagram handle and location in Google Calendar URL
