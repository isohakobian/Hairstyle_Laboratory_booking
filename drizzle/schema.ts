...
export const bookings = mysqlTable("bookings", {
  ...
  referencePhotoKey: varchar("referencePhotoKey", { length: 500 }),
  referencePhotoFileName: varchar("referencePhotoFileName", { length: 255 }),
  referencePhotoMimeType: varchar("referencePhotoMimeType", { length: 100 }),
...
export const bookingEvents = mysqlTable("bookingEvents", {
  ...
  eventType: mysqlEnum("eventType", ["created", "confirmed", "declined", "cancelled", "rescheduled", "completed", "note"]).notNull(),
